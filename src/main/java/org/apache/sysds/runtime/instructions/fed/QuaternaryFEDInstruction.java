...
public abstract class QuaternaryFEDInstruction extends ComputationFEDInstruction
{
  ...
  {
    if(in1.getDataType() != DataType.MATRIX || in2.getDataType() != DataType.MATRIX || in3.getDataType() != DataType.MATRIX || !((in4.getDataType() == DataType.SCALAR && in4_scalar_flag) || in4.getDataType() == DataType.MATRIX))
    {
